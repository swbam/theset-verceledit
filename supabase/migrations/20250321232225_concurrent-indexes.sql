...
-- Songs indexes
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_songs_artist ON setlist_songs(artist_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS songs_setlist_idx ON setlist_songs(setlist_id);
