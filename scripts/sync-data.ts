...
async function fetchArtistFromSpotify(spotifyId: string, token: string) {
...
async function fetchArtistTopTracks(spotifyId: string, token: string, market = 'US') {
...
async function fetchArtistSetlists(mbid: string) {
...
async function syncArtist(name: string, spotifyId: string) {
  try {
...
async function syncSetlists(artistId: string, artistName: string, mbid: string) {
  try {
...
async function createUpcomingShows(artist: any) {
  const futureDates = [
