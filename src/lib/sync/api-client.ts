...
export class APIClientManager {
  ...
  private async callTicketmasterAPI(endpoint: string, params?: Record<string, any>): Promise<any> {
    const apiKey = import.meta.env.VITE_TICKETMASTER_API_KEY; // Use import.meta.env
    if (!apiKey) {
  ...
  private async callSpotifyAPI(endpoint: string, params?: Record<string, any>): Promise<any> {
    const clientId = import.meta.env.VITE_SPOTIFY_CLIENT_ID; // Use import.meta.env
    const clientSecret = import.meta.env.VITE_SPOTIFY_CLIENT_SECRET; // Use import.meta.env
  ...
  private async callSetlistFmAPI(endpoint: string, params?: Record<string, any>): Promise<any> {
    const apiKey = import.meta.env.VITE_SETLIST_FM_API_KEY; // Use import.meta.env
